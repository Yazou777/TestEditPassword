...
class UserController extends AbstractController
{
    ...
    #[Route('/{id}/edit/email', name: 'app_email_edit', methods: ['GET', 'POST'])]
    public function editEmail(Request $request, User $user, UserRepository $userRepository, UserPasswordHasherInterface $userPasswordHasher, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(UserType::class, $user);
        $form->handleRequest($request);
